...
6 years (Apr 2013 – Present)\\Playtech (PTEC)
...
\paragraph{Description}
\footahref{https://github.com/zero-deps/kvs}{Open-sourced} abstract Scala storage framework with high-level API for handling linked lists of polymorphic data (feeds).\\
